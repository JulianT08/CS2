            ...
            try:
                while True:
                    ...
                    if len(dimensions) == 5:
                        ...
                        cost_per_zone = [.03,.03,.04,.05,.25,.35]
                        break
                    else:
                        print('''Error:
                ...
                if length < 0:
                    ...
                    if 'y' in user_breakdown_cost:
                        print(f'''
                              ...
                              The initial cost for a(n) {postage_type} is ${initial_package} and it costs ${cost_travelled} per zone''')    
                    while True:
                        ...
                        if 'y' in user_export_excel:
                            ...
                            with open('post_office.csv', 'w', newline='') as f:
                                writer = csv.writer(f)
                                writer.writerow(['Initial Cost', 'Distance (in zones)', 'Cost per zone', 'TOTAL PRICE'])
